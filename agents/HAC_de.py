...
import utils
from model.agents.DDPG_de import DDPG_de
# from model.agents.BehaviorDDPG import BehaviorDDPG
    
class HAC_de(DDPG_de):
    @staticmethod
    def parse_model_args(parser):
        ...
        - args from DDPG:
            ...
            - args from BaseRLAgent:
                ...
                - save_path
        '''
        parser = DDPG_de.parse_model_args(parser)
...
#         done_mask = torch.FloatTensor(done_mask)
        ...
        critic_loss_one, critic_loss, actor_loss, hyper_actor_loss = self.get_hac_loss(observation, policy_output, reward, done_mask, next_observation)
...
#         Q_S = self.critic({'state_emb': S, 'list_emb': L})['q']
        ...
        current_Q = self.critic2({'state_emb': S, 'action_emb': A})['q']
...
#         critic_reg = current_critic_output['reg']
        ...
        return critic_loss_one, value_loss, actor_loss, hyper_actor_loss
