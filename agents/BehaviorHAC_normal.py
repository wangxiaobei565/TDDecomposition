...
from model.agents.HAC_normal import HAC_normal
    
class BehaviorHAC_normal(HAC_normal):
    '''
    ...
    def parse_model_args(parser):
        ...
        - from DDPG:
            ...
            - args from BaseRLAgent:
                ...
                - save_path
        '''
        parser = HAC_normal.parse_model_args(parser)
...
#             target_param.data.copy_(self.tau * param.data + (1 - self.tau) * target_param.data)
        ...
        return {"step_loss": (self.training_history['behavior_loss'][-1])}
