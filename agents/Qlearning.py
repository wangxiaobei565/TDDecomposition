...
#         done_mask = torch.FloatTensor(done_mask)
        ...
        critic_loss= self.get_q_loss(observation, policy_output, reward, done_mask, next_observation)
    ...
    def get_q_loss(self, observation, policy_output, reward, done_mask, next_observation, 
