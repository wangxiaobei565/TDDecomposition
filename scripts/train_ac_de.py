...
if __name__ == '__main__':
    ...
    init_parser.add_argument('--critic_class1', type=str, default='GeneralCritic', help='Critic class')
    init_parser.add_argument('--critic_class2', type=str, default='GeneralCritic', help='Critic class')
    ...
    criticClass1 = eval('{0}.{0}'.format(initial_args.critic_class1))
    criticClass2 = eval('{0}.{0}'.format(initial_args.critic_class2))
    ...
    parser = criticClass1.parse_model_args(parser)
    parser = criticClass2.parse_model_args(parser)
    ...
    print(policy)
    print("Setup critic:")
    critic1 = criticClass1(args, env, policy)
    critic1.to(device)
    print(critic1)
    
    critic2 = criticClass2(args, env, policy)
    critic2.to(device)
    print(critic2)
