...
mkdir -p output/kr/agents/11TD_decomposition/3reqhac/


output_path="output/kr/"
log_name="kr_user_env_lr0.001_reg0.003_init"

# actor0.00003_critic0.000003
N_ITER=30000
CONTINUE_ITER=0
GAMMA=0.9
TOPK=1
...
#     for CRITIC_LR in 0.0000001 0.000001 0.00001 0.0001 0.001
    do
#         for SCORER in "WideDeep"
        ...
        do
            ...
            do
#                 for ACTOR_LR in 0.0000001 0.000001 0.00001 0.0001 0.001 
                ...
                do
                    ...
                    CUDA_VISIBLE_DEVICES=1 python train_ddpg.py\
                        ...
                        --save_path ${output_path}agents/11TD_decomposition/3reqhac/hac_${SCORER}_actor${ACTOR_LR}_critic${CRITIC_LR}_niter${N_ITER}_reg${REG}_ep${INITEP}_noise${NOISE}_bs${BS}_epbs${EP_BS}_step${MAX_STEP}_seed${SEED}/model\
                        ...
                        --check_episode 10\
                        --topk_rate ${TOPK}\
                        > ${output_path}agents/11TD_decomposition/3reqhac/hac_${SCORER}_actor${ACTOR_LR}_critic${CRITIC_LR}_niter${N_ITER}_reg${REG}_ep${INITEP}_noise${NOISE}_bs${BS}_epbs${EP_BS}_step${MAX_STEP}_seed${SEED}/log
                done
            done
        done
    done
