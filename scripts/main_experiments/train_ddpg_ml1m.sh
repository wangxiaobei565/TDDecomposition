...
mkdir -p output/ml1m/agents/11TD_decomposition/1reqddpg/
...
# ddpg_DotScore_actor0.0000003_critic0.00003_niter30000_reg0.00003_ep0.01_noise0.1_bs64_epbs32_step20_seed11

for MAX_STEP in 20 
do
#     for CRITIC_LR in 0.00003 0.0001 0.0003 0.001 
    for CRITIC_LR in 0.00003 
    do
#         for SCORER in "WideDeep"
        ...
        do
            ...
            do
                for BEHAVE_LR in 0
                do
#                     for ACTOR_LR in 0.0000003 0.000001 0.000003 0.00001
                    for ACTOR_LR in 0.0000003 
                    do
                        ...
                        python train_ddpg.py\
                            ...
                            --save_path ${output_path}agents/11TD_decomposition/1reqddpg/ddpg_${SCORER}_actor${ACTOR_LR}_critic${CRITIC_LR}_niter${N_ITER}_reg${REG}_ep${INITEP}_noise${NOISE}_bs${BS}_epbs${EP_BS}_step${MAX_STEP}_seed${SEED}/model\
                            ...
                            --check_episode 10\
                            --topk_rate ${TOPK}\
                            > ${output_path}agents/11TD_decomposition/1reqddpg/ddpg_${SCORER}_actor${ACTOR_LR}_critic${CRITIC_LR}_niter${N_ITER}_reg${REG}_ep${INITEP}_noise${NOISE}_bs${BS}_epbs${EP_BS}_step${MAX_STEP}_seed${SEED}/log
                    done
                done
            done
        done
