...
mkdir -p output/ml1m/agents/11TD_decomposition/4de_reqhac/
...
for CRITIC2_LR in 0.000003 0.00001 0.00003 
do
    for CRITIC1_LR in 3e-6 1e-5
    do
#         for SCORER in "WideDeep"
        ...
        do
            ...
            do
                for ACTOR_LR in 0.000001 0.000003 0.00001
                do
                    ...
                    python train_ac_de.py\
                        ...
                        --save_path ${output_path}agents/11TD_decomposition/4de_reqhac/de_hac_${SCORER}_actor${ACTOR_LR}_critic${CRITIC1_LR}_${CRITIC2_LR}_niter${N_ITER}_reg${REG}_ep${INITEP}_noise${NOISE}_bs${BS}_epbs${EP_BS}_step${MAX_STEP}_seed${SEED}/model\
                        ...
                        --check_episode 10\
                        --topk_rate ${TOPK}\
                        > ${output_path}agents/11TD_decomposition/4de_reqhac/de_hac_${SCORER}_actor${ACTOR_LR}_critic${CRITIC1_LR}_${CRITIC2_LR}_niter${N_ITER}_reg${REG}_ep${INITEP}_noise${NOISE}_bs${BS}_epbs${EP_BS}_step${MAX_STEP}_seed${SEED}/log
                done
            done
        done
    done
