...
mkdir -p output/kr/agents/1TD_others/de_reqhac_ab_Q/
...
for CRITIC2_LR in 0.00000003 0.0000003 0.000003 0.0003 0.003 0.03
do
...
#         for SCORER in "WideDeep"
        ...
        do
            ...
            do
                ...
                do
                    mkdir -p ${output_path}agents/1TD_others/de_reqhac_ab_Q/de_hac_${SCORER}_actor${ACTOR_LR}_critic${CRITIC1_LR}_${CRITIC2_LR}_niter${N_ITER}_reg${REG}_ep${INITEP}_noise${NOISE}_bs${BS}_epbs${EP_BS}_step${MAX_STEP}_seed${SEED}/
                    ...
                    python train_ac_de.py\
                        ...
                        --save_path ${output_path}agents/1TD_others/de_reqhac_ab_Q/de_hac_${SCORER}_actor${ACTOR_LR}_critic${CRITIC1_LR}_${CRITIC2_LR}_niter${N_ITER}_reg${REG}_ep${INITEP}_noise${NOISE}_bs${BS}_epbs${EP_BS}_step${MAX_STEP}_seed${SEED}/model\
                        ...
                        --check_episode 10\
                        --topk_rate ${TOPK}\
                        > ${output_path}agents/1TD_others/de_reqhac_ab_Q/de_hac_${SCORER}_actor${ACTOR_LR}_critic${CRITIC1_LR}_${CRITIC2_LR}_niter${N_ITER}_reg${REG}_ep${INITEP}_noise${NOISE}_bs${BS}_epbs${EP_BS}_step${MAX_STEP}_seed${SEED}/log
                done
            done
        done
    done
