...
from model.facade.OneStageFacade_de import OneStageFacade_de

class OneStageFacade_HyperAction_de(OneStageFacade_de):
    '''
    ...
    def parse_model_args(parser):
        ...
        - empty_start_rate
        '''
        parser = OneStageFacade_de.parse_model_args(parser)
        return parser
        
    def __init__(self, args, environment, actor, critic1, critic2):
        super().__init__(args, environment, actor, critic1, critic2)
